...
<body>
<header id="contact_top" role="banner">
    <div class="header-bg">
        <div class="navbar-header">
            ...
            <a href="<?php echo BASE_URL; ?>" ><div class="main-logo"></div></a>
        </div>
        <div class="container">

            <nav class="collapse navbar-collapse bs-navbar-collapse">
                <ul class="nav navbar-nav navbar-right">
                    <li class="need_help"><a href="http://warbble.zendesk.com" target="_blank" >Need Help?</a></li>
            ...
            <div class="col-md-12 tagline">
                <div class="tagline_wrap">
                    <h1>Discover the Warbble</h1>
                    <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore.
                        Ut enim ad minim veniam.</p>
                    <p><a role="button" href="#" class="btn btn-lg btn-primary get_started">Join</a></p>
                </div>
            </div>
        </div>
    </div>
