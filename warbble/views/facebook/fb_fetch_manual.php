        ...
        <table class="table table-hover">
            ...
            <?php foreach ($users as $user): ?>
                <tr>
                    ...
                    <td>
                        <?php if($user->is_connect_fbstream == Users_Model::TW_CONN_STATUS_CONNECTED): ?>
                            <div class="col-xs-12 green centered" data-toggle="tooltip" title="Connected"><i class="fa fa-check"></i></div>
                        <?php elseif($user->is_connect_fbstream == Users_Model::TW_CONN_STATUS_DISCONNECTED): ?>
                            <div class="col-xs-12 red centered" data-toggle="tooltip" title="Disconnected"><i class="fa fa-times"></i></div>
                        <?php elseif($user->is_connect_fbstream == Users_Model::TW_CONN_STATUS_IN_PROCESS): ?>
