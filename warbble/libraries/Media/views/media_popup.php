...
?>
<div id="medialibrary" class="modal fade" role="dialog" aria-labelledby="gridSystemModalLabel" data-user-id="<?php echo $current_user->user_id; ?>" data-type="<?php echo $type; ?>">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="pagination-media"></div>
            </div><!-- /.modal-body -->
        </div><!-- /.modal-content -->
    </div><!-- /.modal-dialog -->
</div><!-- /.modal -->
