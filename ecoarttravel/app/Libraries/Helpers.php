...
class Helpers {
    ...
    public static function displayShortDayDate($date){
    ...
    public static function makeColor($color){
    ...
    public static function constructUnavailabilityText($tods)
    {
        $tods = explode(",",$tods);
        ...
        foreach($tods as $tod){
            $todArrayString[] = $map[$tod];
        }

        return "Unavailability for ".implode(", ",$todArrayString);
    }
}