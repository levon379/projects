...
class TourManagerRepository {
    ...
    public function getDates($limit = 6 , $page = 1 , $startDate = "",$providerFilter = [],$user= null,$one_day = null){

        $startFrom = ($page-1) * $limit;

        $queryString = "SELECT b.id, b.travel_date AS `date`, SUM(b.total_pax) AS total_bookings
                        FROM   bookings b ";
        ...
        $queryString .= " WHERE 1 = 1 AND b.pending=0 ";
    ...
    public function getAvailabilitySlotsByDate($date,$showPackage,$providerFilter){
        ...
        $queryString = "SELECT av.id AS availability_slot_id
                        ...
                        WHERE  b.travel_date = '$date' AND b.pending=0";
    ...
    public function getTotalsByAvailabilityAndDate($availability,$date){
        $queryString = "SELECT SUM(total_pax)                                        AS total_bookings,
                        ...
                        WHERE  b.travel_date = '$date'
                               AND av.id = $availability
                               AND b.deleted = 0 AND b.refunded = 0 AND b.pending = 0
                        GROUP  BY av.id ";
