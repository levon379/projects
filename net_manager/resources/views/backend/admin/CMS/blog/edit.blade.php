...
<section>
    ...
    <div class="content-wrapper">
        ...
        <!-- START row-->
        <div class="row">
            {{ Form::open(array('url' => 'admin/blog/update/'.$blog_article->id,'method'=>'POST', 'files'=>true)) }}
            <div class="col-lg-9">
                ...
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        <div class="form-group">
                            ...
                            <input type="text" name="title" placeholder="Page title..." value="{{ $blog_article->title }}" class="mb-lg form-control input-lg">
                        </div>
                        <fieldset>
                            <div class="form-group">
                                <label class="control-label">{{trans('backend.blog.content')}} *</label>
                                <textarea name="content" id="content" class="form-control" rows="10" cols="80">{{ $blog_article->content }}</textarea>                           
                            </div>
                        </fieldset>
                        <fieldset>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <label class="switch switch-lg">
                                        <input type="checkbox" name="status" @if($blog_article->status == 1) checked="checked" @endif>
                                        <span></span>
                                    </label>
                                </div>
                            </div>
