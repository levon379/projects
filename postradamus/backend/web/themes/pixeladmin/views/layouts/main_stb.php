            ...
            <div class="navbar-header">
                ...
                <style>
                    .gt-ie9 .theme-adminflare #main-navbar, .gt-ie9 .theme-adminflare #main-navbar .navbar-header {
                        background-image: linear-gradient(to bottom,#EC8CFC 0,#DF3FFA 100%);
                    }
...
<?php */ ?>
 ...
 <?php */ ?>
            ...
            <div class="menu-content">
                <a href="SOCIALTRAFFICBOOSTER_SUPPORTURL" class="btn btn-primary btn-block"><i class="menu-icon fa fa-question-circle"></i> Help</a>
