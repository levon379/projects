...
if (!class_exists("nxs_class_SNAP_FF")) {
    class nxs_class_SNAP_FF
    {
        ...
        function doPostToNT($options, $message)
        {
            ...
            if (is_wp_error($cnt)) $ret = 'Something went wrong - ' . print_r($cnt, true);
                ...
                if (is_array($cnt)) $retInfo = json_decode($cnt['body'], true); else $retInfo = false;
