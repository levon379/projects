...
if (!class_exists("nxs_class_SNAP_TR")) {
    class nxs_class_SNAP_TR
    {
        ...
        function doPostToNT($options, $message)
        {
            ...
            if (empty($message['postDate'])) $message['postDate'] = '';
            ...
            if (substr($options['trURL'], -1) == '/') $options['trURL'] = substr($options['trURL'], 0, -1);
