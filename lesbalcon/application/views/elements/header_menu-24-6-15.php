	...
	<div role="navigation" class="navbar navbar-inverse navbar-static-top">
	  ...
	  <div class="navbar-collapse collapse menubg">
		<ul class="nav navbar-nav">
		  ...
		  <li class="dropdown">
			<a style="cursor:pointer;" class="dropdown-toggle <?php if($current_controller=="situation" || $current_controller=="rates" || $current_controller=="properties" || $current_controller=="our-residence" || $current_controller=="testimonials"){ echo "active"; } ?>" data-toggle="dropdown1" href="<?php echo base_url(); ?>our-residence" ><?php echo lang('Our_Residence'); ?>
			<!--<span class="caret"></span>-->
			</a>
			<ul class="dropdown-menu" role="menu">
			  <li><a class="<?php echo ($current_controller=="situation")?'active':''; ?>" href="<?php echo base_url(); ?>situation" ><?php echo lang('Situation'); ?></a></li>
