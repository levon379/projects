...
function change_language(lang_id)
{
	...
	//	alert(<?php echo base_url(uri_string()); ?>)'
	...
	<div class="language">
	  <ul>
		<form method="post" id="language_form" action="<?php echo base_url(); ?>home/set_language">
			...
			{
				?>
				<li <?php if($this->session->userdata("current_lang_name")==$lang['language_name']){ echo "class='active'"; } ?>><a style="cursor:pointer;" href="<?php echo base_url(); ?>home/set_language/<?php echo $lang['id'] ?>"  ><?php //echo lang($lang['language_name']); ?><span><img src="<?php echo base_url(); ?>assets/upload/flag/<?php echo $lang['flag_image_name'] ?>" alt=""></span></a></li>
				<?php 
			}
			?>
		</form>
