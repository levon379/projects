    ...
    <div class="container">
		...
		<div class="row">
			...
			<div class="col-md-4 col-xs-12 col-sm-3 logo"> 
				...
				<p style="font-size: 28px;"><?php echo lang('VACATIONS_RENTALS') ?></p> 
			</div>
			...
			<div class="col-md-7 col-xs-12 col-sm-8"> 
				...
				<div class="socialmedia"> 
					...
					<a target="_blank" href="http://www.tripadvisor.com/Hotel_Review-g1723175-d583624-Reviews-Les_Balcons_d_Oyster_Pond-Oyster_Pond_Sint_Maarten_St_Maarten_St_Martin.html"><img width='202px;' height='48px;'src="<?php echo base_url(); ?>assets/images/tripadvisor.png" alt="Trip Advisor"></a>
				</div>
				<div class="language">
					<ul>
						<form method="post" id="language_form" action="<?php echo base_url(); ?>home/set_language"> <?php
							...
							foreach($all_lang as $lang) { ?>
								<li <?php echo ($this->session->userdata("current_lang_name")==$lang['language_name'])?"class='active'":''; ?>>
									...
									*/ ?> 
									<a href="<?php echo base_url(); ?>home/edit_language?lang_id=<?php echo $lang['id'] ?>&referer=<?php echo urlencode($_SERVER['REQUEST_URI']); ?>"> 
										<span><img src="<?php echo base_url() .'assets/upload/flag/'. $lang['flag_image_name'] ?>" alt="<?php echo $lang['language_name']; ?>" /></span>
									</a>
								</li> <?php 
							} ?>
