...
<div class="container">
	<div role="navigation" class="navbar navbar-inverse navbar-static-top">
	  <div class="navbar-header" id="dev_menu">
		<button data-target=".navbar-collapse" data-toggle="collapse" class="navbar-toggle" type="button" onclick="scroll_to_menu()"> <span class="sr-only">Toggle navigation</span> <span class="icon-bar"></span> <span class="icon-bar"></span> <span class="icon-bar"></span> </button>
	  </div>
	  <div class="navbar-collapse collapse menubg">
		<ul class="nav navbar-nav">
		  ...
		  <li class="dropdown">
			<a style="cursor:pointer;" class="dropdown-toggle <?php if($current_controller=="properties" || $current_controller=="bungalows" || $current_controller=="testimonials"){ echo "active"; } ?>" data-toggle="dropdown" ><?php echo lang('Our_Residence'); ?>
			<!--<span class="caret"></span>-->
			</a>
			<ul class="dropdown-menu" role="menu">
			  <li><a href="<?php echo base_url(); ?>situation" ><?php echo lang('Situation'); ?></a></li>
			  <li><a href="<?php echo base_url(); ?>bungalows"><?php echo lang('Bungalows'); ?></a></li>
