	...
	<ul class="sidebar-menu">
		...
		<li class="treeview">
			...
			<ul class="treeview-menu">				
				...
				<li>
					<a href="<?php echo base_url() ?>admin/testimonials/view_testimonials/<?php echo $default_language_id; ?>">
						<i class="fa fa-file-text"></i> <span><?php echo lang("Testimonials_Management"); ?></span>
					</a>
				</li>
				<li>
					<a href="<?php echo base_url() ?>admin/rates/list_rates/<?php echo $default_language_id; ?>">
						<i class="fa fa-money"></i> <span><?php echo lang("Manage_Tarifs"); ?></span>
					</a>
				</li>
				<li class="treeview">
					<a style="cursor:pointer;">
