	...
	<!-- <div class="row">
        ...
        <style>
            ...
            @media print{
                ...
                .calender-style td,.bunglow-style td{ height: 23px !important}
                #helptag div { max-width: 127px; height: 23px !important; margin: 0}
						...
						foreach($bungalows_arr as $bungalows){
							...
							<tr><?php 
								...
								for($i=1; $i<=$days_count_in_current_month; $i++){
									...
									<td id="<?php echo $unique_id."-".$current_date; ?>" class="<?php echo $cell_class?>" align="left" valign="top" <?php echo $reserved_class; ?> <?php echo $mouse_over_function; ?>>&nbsp;<?php 
										 ?>
										<span class="res_block"  style="<?php/*position:absolute; */  ?>width:80px"   ><!-- Width Given by Wasim-->
										...
										<input type="hidden" id="cleaning_date" name="cleaning_date" value="<?php echo $cleaning_date; ?>" />
											...
											?>
											<span class="user_name" style="color: <?php echo $forecolor; ?>;">
											<?php
