	...
	<div class="row">
		<div class="col-md-12">
			...
			<div class="box box-primary">
				<form role="form" id="form" action="<?php echo base_url(); ?>admin/news/news_edit/<?php echo $this->uri->segment(4); ?>/<?php echo $this->uri->segment(5); ?>" method="POST" enctype="multipart/form-data" onsubmit="return check_form()">
					<div class="box-body">
						<div class="horizontal_div_full">
							<?php echo lang('Set_language_Specific_content'); ?>
						</div>
						<input type="hidden" value="<?php echo $this->uri->segment(5); ?>" name="news_id">
						<input type="hidden" value="<?php echo $this->uri->segment(4); ?>" name="language_id">
						<?php 
						$language_id_arr=array();
						foreach($news_arr as $language)
						{
							...
							<div id="div_<?php echo $language['id']; ?>">
								<div class="form-group">
									...
									<input type="text" name="news_title<?php echo $language['id'] ?>" id="news_title<?php echo $language['id'] ?>" class="form-control" placeholder="<?php echo lang('NEWS_TITLE'); ?>" value="<?php echo $language['title']; ?>">
								...
								<div class="form-group">
									...
									<?php								
										...
										$code = $CKEditor->editor("news_content".$language['id'], $language['content']);
										echo $code;
									?>
