...
<section class="content-header">
	...
	<ol class="breadcrumb">
		...
		<li class="active">Edit Sent Mail Type</li>
	</ol>
</section>
<script>
	function check_form()
	...
	<div class="row">
		<div class="col-md-12">
			...
			<div class="box box-primary">
				<form role="form" id="form" action="<?php echo base_url(); ?>admin/sent_mail_type/sent_mail_type_edit/<?php echo $this->uri->segment(4); ?>/<?php echo $this->uri->segment(5); ?>" method="POST" enctype="multipart/form-data" onsubmit="return check_form()">
					<div class="box-body">
						<div class="horizontal_div_full">
							Set Language Specific Content
						</div>
						<input type="hidden" value="<?php echo $this->uri->segment(5); ?>" name="type_id">
						<input type="hidden" value="<?php echo $this->uri->segment(4); ?>" name="language_id">
						<?php 
						$language_id_arr=array();
						foreach($sent_mail_type_arr as $language)
						{
							...
							<div id="div_<?php echo $language['id']; ?>">
								<div class="form-group">
									...
									<input type="text" name="title<?php echo $language['id'] ?>" id="title<?php echo $language['id'] ?>" class="form-control" placeholder="Title" value="<?php echo $language['title']; ?>">
