...
<div class="box_horizontal">
	...
	{
		?>
		<a style="width:30px; margin-top:5px; float:left;" title="<?php echo $language['language_name']; ?>" href="<?php echo base_url(); ?>admin/bunglow/view_testimonials/<?php echo $language['id']; ?>/<?php echo $this->uri->segment(5);?>">
...
<div class="box_horizontal">
	...
	<a href="<?php echo base_url(); ?>admin/bunglow/add_testimonials/<?php echo $this->uri->segment(5);?>" class="btn btn-primary btn-flat"><?php echo lang("Add_New"); ?></a>
							...
							{	
								...
								foreach($all_rows as $row)
								{
									...
									<tr>
										...
										<td>
										<a href="<?php echo base_url().'admin/bunglow/edit_testimonials/'.$row['language_id']."/".$row['testimonials_id']."/".$this->uri->segment(5);?>"><img width="16px" height="16px" alt="" title="To edit click here" src="<?php echo base_url(); ?>assets/admin/images/icons/user_edit.png"></a>
										<a onclick="return confirm('Are you sure to delete?')" href="<?php echo base_url().'admin/bunglow/delete_testimonials/'.$this->uri->segment(4).'/'.$row['bunglow_id'].'/'.$row['id'];?>"><img width="16px" height="16px" alt="" title="To delete click here" src="<?php echo base_url(); ?>assets/admin/images/icons/trash-can-delete.png"></a>
