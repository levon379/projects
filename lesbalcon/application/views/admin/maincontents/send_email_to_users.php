					...
					<div class="box-body">
						...
						<div class="form-group">
							...
							<div style="color:red"><?php echo $selected_user; ?></div>
                                            ...
                                            <div class="form-group">
					<label for="exampleInputPassword1">OR SEND EMAIL TO</label>
                                        <input type="email" name="sendemailto" placeholder="Leave Empty if you don't want to use manual email address" id="sendemailto" class="form-control" value="">
