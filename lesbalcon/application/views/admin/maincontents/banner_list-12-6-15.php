					...
					<table <?php if($all_rows){ echo 'id="data_table"'; } ?> class="table table-bordered table-striped">
						<thead>
							<tr>
								...
								<th class="sorting_disabled">Banner Image</th>
								...
								foreach($all_rows as $row)
								{
									...
									<tr>
										...
										<td>
											...
											{ 
											?>
												<a href="<?php echo base_url().'admin/banner/inactive/'.$row['banner_id'];?>" title="To inactive click here"><font color="green">Active</font></a>
											<?php 
											} 
											else 
											{ ?>
												<a href="<?php echo base_url().'admin/banner/active/'.$row['banner_id'];?>" title="To active click here"><font color="red">Inactive</font></a>
											<?php 
											} 
											?>
										</td>
										<td align="center">
											<a href="<?php echo base_url().'admin/banner/banner_edit/'.$row['language_id']."/".$row['banner_id'];?>"><img width="16px" height="16px" alt="" title="To edit click here" src="<?php echo base_url(); ?>assets/admin/images/icons/user_edit.png"></a>
											<a onclick="return confirm('Are you sure to delete?')" href="<?php echo base_url().'admin/banner/delete/'.$row['banner_id'];?>"><img width="16px" height="16px" alt="" title="To delete click here" src="<?php echo base_url(); ?>assets/admin/images/icons/trash-can-delete.png"></a>
										</td>
									</tr>
									<?php 
									$sl_no++;
