...
<section class="content-header">
	<h1>
		<?php echo lang('Edit_Tax'); ?>
	</h1>
	<ol class="breadcrumb">
		<li><a href="<?php echo base_url(); ?>admin"><i class="fa fa-dashboard"></i> <?php echo lang('Home'); ?></a></li>
		<li class="active"><?php echo lang('Edit_Tax'); ?></li>
	</ol>
</section>
<script>
	function check_form()
	...
	<div class="row">
		<div class="col-md-12">
			...
			<div class="box box-primary">
				<form role="form" id="form" action="<?php echo base_url(); ?>admin/tax/tax_edit/<?php echo $this->uri->segment(4); ?>/<?php echo $this->uri->segment(5); ?>" method="POST" enctype="multipart/form-data" onsubmit="return check_form()">
					<div class="box-body">
						<div class="horizontal_div_full">
							<?php echo lang('Set_Language_independent_content'); ?>
						</div>
						<input type="hidden" value="<?php echo $this->uri->segment(5); ?>" name="tax_id">
						...
						<div class="form-group">
							...
							<input type="text" name="rate_in_percentage" id="rate_in_percentage" class="form-control" placeholder="<?php echo lang('RATE_IN'); ?> (%)" value="<?php echo $tax_unique_details[0]['rate']; ?>" onkeyup="validate_numeric_field(this.value, this.id)">
						...
						foreach($tax_arr as $language)
						{
							...
							<div id="div_<?php echo $language['id']; ?>">
								<div class="form-group">
									...
									<input type="text" name="tax_name<?php echo $language['id'] ?>" id="tax_name<?php echo $language['id'] ?>" class="form-control" placeholder="<?php echo lang('TAX_NAME'); ?>" value="<?php echo $language['tax_name']; ?>">
									<div class="form-group has-error" id="tax_name_error<?php echo $language['id'] ?>" style="display:none;">
										<label class="control-label" for="inputError">
										<i class="fa fa-times-circle-o"> Tax Name field is required</i>
										</label>
									</div>
								</div>
							</div>
