								...
								foreach($all_rows as $row)
								{
									...
									<tr>
										...
										<td>
											...
											{ 
											?>
												<a href="<?php echo base_url().'admin/gallery/inactive/'.$row['gallery_id'];?>" title="To inactive click here"><font color="green">Active</font></a>
											<?php 
											} 
											else 
											{ ?>
												<a href="<?php echo base_url().'admin/gallery/active/'.$row['gallery_id'];?>" title="To active click here"><font color="red">Inactive</font></a>
											<?php 
											} 
											?>
										</td>
										<td>
											...
											{ 
											?>
												<a href="<?php echo base_url().'admin/gallery/set_featured/'.$row['gallery_id'];?>" title="To unset featured click here"><font color="green">Featured</font></a>
											<?php 
											} 
											else 
											{ ?>
												<a href="<?php echo base_url().'admin/gallery/set_featured/'.$row['gallery_id'];?>" title="To set featured click here"><font color="red">Set Featured</font></a>
											<?php 
											} 
											?>
										</td>
