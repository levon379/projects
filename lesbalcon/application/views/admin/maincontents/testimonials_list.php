							...
							{	
								...
								foreach($all_rows as $row)
								{
									...
									<tr>
										...
										<?php /*?><td><?php echo $row['status']; ?></td><?php */?>
										<?php /*?><td align="center">
										...
										<td>
										<a href="<?php echo base_url().'admin/testimonials/edit_testimonials/'.$row['language_id']."/".$row['testimonials_id'];?>"><img width="16px" height="16px" alt="" title="<?php echo lang('To_Edit_Click_Here');?>" src="<?php echo base_url(); ?>assets/admin/images/icons/user_edit.png"></a>
										<a onclick="return confirm('Are you sure to delete?')" href="<?php echo base_url().'admin/testimonials/delete_testimonials/'.$this->uri->segment(4).'/'.$row['testimonials_id'];?>"><img width="16px" height="16px" alt="" title="<?php echo lang('To_Delete_Click_Here');?>" src="<?php echo base_url(); ?>assets/admin/images/icons/trash-can-delete.png"></a>
										<a style="cursor:pointer;" data-toggle="modal" data-target="#message_div<?php echo $row['id']; ?>"><img width="16px" height="16px" alt="" title="<?php echo lang('View_Message');?>" src="<?php echo base_url(); ?>assets/admin/images/icons/viewdetails.png"></a>
										</td>
									</tr>
										...
										<div class="modal-dialog">
											<div class="modal-content">
												<div class="modal-header">
													...
													<h4 class="modal-title"><i class="fa fa-envelope-o"></i><?php lang('Testimonials');?></h4>
												</div>
