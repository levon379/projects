			...
			<div class="box">
				<div class="box-body table-responsive">
					<table class="table table-bordered table-striped">
						<thead>
							<tr>
								<th style="text-align:center;" colspan="6"><h4>Latest Booking</h4></th>
							</tr>
							<tr>
								<th class="sorting_disabled">Date</th>
								<th class="sorting_disabled">Arrival Date</th>
								<th class="sorting_disabled">Leave Date</th>
              ...
              <tr>
				...
				<?php 
					if(count($bungalows_arr)>0)//If bungalows are available 
					{
						...
						{
							$bungalow_name_arr=str_split($bungalows['bunglow_name']);
							?>
								<td align="left" valign="top"><?php echo implode("<br>", $bungalow_name_arr); ?></td>
							<?php
						}
					}
					?>
