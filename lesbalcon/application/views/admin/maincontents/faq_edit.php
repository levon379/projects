	...
	<div class="row">
		<div class="col-md-12">
			...
			<div class="box box-primary">
				<form role="form" id="form" action="<?php echo base_url(); ?>admin/faq/faq_edit/<?php echo $this->uri->segment(4); ?>/<?php echo $this->uri->segment(5); ?>" method="POST" enctype="multipart/form-data" onsubmit="return check_form()">
					<div class="box-body">
						<div class="horizontal_div_full">
							Set Language Specific Content
						</div>
						<input type="hidden" value="<?php echo $this->uri->segment(5); ?>" name="faq_id">
						<input type="hidden" value="<?php echo $this->uri->segment(4); ?>" name="language_id">
						<?php 
						$language_id_arr=array();
						foreach($faq_arr as $language)
						{
							...
							<div id="div_<?php echo $language['id']; ?>">
								<div class="form-group">
									...
									<input type="text" name="question<?php echo $language['id'] ?>" id="question<?php echo $language['id'] ?>" class="form-control" placeholder="Question" value="<?php echo $language['faq_question']; ?>">
								...
								<div class="form-group">
									...
									<textarea name="answer<?php echo $language['id'] ?>" id="answer<?php echo $language['id'] ?>" class="form-control" placeholder="Answer" rows="3"><?php echo $language['faq_answer']; ?></textarea>
