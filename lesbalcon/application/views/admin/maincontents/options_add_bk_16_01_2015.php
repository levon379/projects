...
<section class="content-header">
	...
	<ol class="breadcrumb">
		...
		<li class="active">Add Options</li>
	</ol>
</section>
<script>
	function check_form()
	...
	<div class="row">
		<div class="col-md-12">
			...
			<div class="box box-primary">
				<form role="form" id="form" action="<?php echo base_url(); ?>admin/options/options_add" method="POST" enctype="multipart/form-data" onsubmit="return check_form()">
					<div class="box-body">
						...
						<div class="form-group">
							...
							<input type="text" name="charge_in_dollars" id="charge_in_dollars" class="form-control" placeholder="Charge In (&dollar;)" value="" onkeyup="validate_numeric_field(this.value, this.id)">
							<div class="form-group has-error" id="charge_in_dollars_error" style="display:none;">
								<label class="control-label" for="inputError">
								<i class="fa fa-times-circle-o" id="charge_in_dollars_error_text"> Charges In (&dollar;) field is required</i>
								</label>
							</div>
						</div>
						<div class="form-group">
							<label for="exampleInputEmail1">CHARGES IN (&euro;)<span style="color:red">*</span></label>
							<input type="text" name="charge_in_euro" id="charge_in_euro" class="form-control" placeholder="Charge In (&euro;)" value="" onkeyup="validate_numeric_field(this.value, this.id)">
							<div class="form-group has-error" id="charge_in_euro_error" style="display:none;">
								<label class="control-label" for="inputError">
								<i class="fa fa-times-circle-o" id="charge_in_euro_error_text"> Charges In (&euro;) field is required</i>
								</label>
							</div>
						</div>
						<div class="horizontal_div_full">
						...
						foreach($language_arr as $language)
						{
							...
							<div id="div_<?php echo $language['id']; ?>">
								<div class="form-group">
									...
									<input type="text" name="options_name<?php echo $language['id'] ?>" id="options_name<?php echo $language['id'] ?>" class="form-control" placeholder="Option Name" value="">
