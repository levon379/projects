			...
			<div class="box box-primary">
				<!-- form start -->
					<div class="box-body table-responsive">
						...
						<form action="<?php echo base_url()."admin/users/invoice/".$reservation_id; ?>" method="POST" id="euro_invoice_form">
							<table class="table table-hover">
								...
								<tr bgcolor="#f5e8c8">
									...
									<td style="border-top:1px solid #C9AD64; padding:5px; border-left:1px solid #C9AD64;">
										<input style="width:100%;" type="text" name="bungalow_name" id="bungalow_name" value="<?php echo $invoice_details[0]['bungalow_name'] ?>">
									</td>
								</tr>
								<tr>
								...
								<tr bgcolor="#f5e8c8">
									...
									<td style="border-top:1px solid #C9AD64; padding:5px; border-left:1px solid #C9AD64;">
										<input style="width:100%;" type="text" name="tax_text_for_mail" id="tax_text_for_mail" value="<?php echo $invoice_details[0]['tax_text_for_mail']; ?>">
									</td>
								</tr>
								<tr>
								...
								<tr bgcolor="#f5e8c8">
									...
									<td style="border-top:1px solid #C9AD64; padding:5px; border-left:1px solid #C9AD64;">
										<input style="width:100%;" type="text" name="payment_status" id="payment_status" value="<?php echo $invoice_details[0]['payment_status']; ?>">
									</td>
								</tr>
								<tr>
									<td style="border-top:1px solid #C9AD64; padding:5px;"><b>Reservation Status: </b></td >
									<td style="border-top:1px solid #C9AD64; padding:5px; border-left:1px solid #C9AD64;">
										<input style="width:100%;" type="text" name="reservation_status" id="reservation_status" value="<?php echo $invoice_details[0]['reservation_status']; ?>">
									</td>
								</tr>
								<tr bgcolor="#f5e8c8">
						...
						<form action="<?php echo base_url()."admin/users/invoice/".$reservation_id; ?>" method="POST" id="dollar_invoice_form" style="display:none;">
							<table class="table table-hover">
								<input type="hidden" name="reservation_id" id="reservation_id" value="<?php echo $reservation_id; ?>">
								<input type="hidden" name="user_id" id="reservation_id" value="<?php echo $user_id; ?>">
