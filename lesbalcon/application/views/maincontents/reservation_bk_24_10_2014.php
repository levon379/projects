      		...
      		<div class="reservation_block">
                <form id="reservation_form" class="form-login form-horizontal" action="" method="POST">
                    ...
                    <div class="form-row form-group">
                      ...
                      <div class="col-md-7">
						<input id="name" name="name" class="login-input testi-input form-control input-md" type="text">
                    ...
                    <div class="form-row form-group">
                      ...
                      <div class="col-md-7">
						<div class='input-group date' id='datetimepicker5'>
							<input id="arrival_date" name="arrival_date" type='text' class="login-input testi-input form-control input-md" data-date-format="YYYY-MM-DD" readonly/>
                    ...
                    <div class="form-row form-group">
                      ...
                      <div class='input-group date' id='datetimepicker6'>
						<input name="leave_date" id="leave_date" type='text' class="login-input testi-input form-control input-md" data-date-format="YYYY-MM-DD" readonly/>
						...
						<select name="bungalow" id="bungalow" class="login-input testi-input form-control input-md" onchange="get_options(this.value)">
							...
							<?php
								if(count($properties_arr)>0)
								{
									...
									{
										?>
										<option value="<?php echo $properties['id'] ?>"><?php echo $properties['bunglow_name'] ?></option>
										<?php 
									}
								}
							?>
						...
						<div class="col-md-10">
							<div class="row">
								<div class="col-md-12">
									...
									<div class="sub-btn" id="resrvation_progress" style="display:none;"> 
