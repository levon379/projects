...
<div class="row innerpage-section">
	<div class="container">
		<h2><img src="<?php echo base_url() ?>assets/frontend/images/bracket-left.png" alt=""><?php echo lang('bungalow_listing'); ?><img src="<?php echo base_url(); ?>assets/frontend/images/bracket-right.png" alt=""></h2>
				...
				if(count($bungalows)>0)
				{
					foreach($bungalows as $value)
					{
						...
						<div class="col-xs-6 col-sm-4 col-md-4">
							...
							<div class="button"><p><a href="<?php echo base_url(); ?>bungalows/<?php echo $value['slug']; ?>"><?php echo lang('VIEW_DETAILS'); ?></a></p></div>
