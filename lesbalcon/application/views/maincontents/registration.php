...
function check_register_form()
{
	...
	if($("#user_name").val().trim()=="")
	{
		...
		if (!re.test($("#user_name").val())) {
			$("#name_error").html("Special character is not allow<?php //echo lang('valid_Name_is_required'); ?>");
			error++;
		}else{
			$("#name_error").html("");
		}
					...
					if($error_message == "User_already_exist") {
						...
						<div id="example-popup" class="popup visible">
							...
							<div class="popup-content">
								...
								<label style="margin-top:5px;">If your email is already registered, please <span style="text-decoration:underline"><a href="<?php echo base_url(); ?>user/forgot_password">click here</a></span> to generate a new one.</label>
								<?php } else{ ?> 
								<h2 class="popup-title">Déjà Membre</h2>
								<label style="margin-top:5px;">Si votre email est déjà enregistré, merci de régénérer un nouveau mot de passe en <span style="text-decoration:underline"><a href="<?php echo base_url(); ?>user/forgot_password">cliquant ici</a></span>.</label>
								<?php } ?>
							</div>
							</div>
						</div>
      		...
      		<div class="login_block">
				<form class="form-login form-horizontal" action="" onsubmit="return check_register_form()" method="POST">
                    <fieldset>
						...
						<div class="form-row form-group">
						  <div class="col-md-3">
						  <label><?php echo lang('FULL_NAME'); ?><span style="color:red;">*<span></label>
						  </div>
						  <div class="col-md-9">
						...
						<div class="form-row form-group">
						  ...
						  <div class="col-md-9">
						   <textarea class="contact-textar testi-textarea form-control" style="color: rgb(0, 0, 0)!important;" name="user_address" id="user_address"></textarea>
						...
						<div class="form-row form-group">
						  ...
						  <div class="col-md-9">
						   <textarea class="contact-textar testi-textarea form-control"  style="color: rgb(0, 0, 0)!important;" name="user_notes" id="user_notes"></textarea>
						  </div>
						</div>
