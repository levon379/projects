                    ...
                    <!--<?php 
						...
						<div class="tab-text">
							<ul class="rates-section">
								...
								<li class="table-row">
									<ul>
										<li class="hidden-field">Summer</li>
										<li>11</li>
										<li class="hidden-field">winter</li>
										<li>12</li>
										<li class="hidden-field">Spring</li>
										<li>13</li>
										<li class="hidden-field">Autumn</li>
										<li>14</li>
									</ul>
								</li>
							</ul>
			...
			<div class="row testimonial-form">
				...
				<form class="form-testimonial form-horizontal" action="" method="POST" onsubmit="return validate_testimonials_form()">
					<fieldset>
						...
						<div class="form-row form-group">
						  <div class="col-md-12">                     
							<textarea name="test_comment" id="test_comment" class="testi-textarea form-control" placeholder="<?php echo lang('Description'); ?>" name="<?php echo lang('Description'); ?>"></textarea>
						  </div>
						</div>
						<!-- Button -->
						<div class="form-row form-group">
