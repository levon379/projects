      ...
      <form class="search-form form-horizontal" id="details_form_search" action="<?php echo base_url() ?>search" method="post">
        ...
        <div class="col-md-4">
          ...
          <select name="search_keyword" class="search-input input-md" id="search_keyword">
            <option value=""> <?php echo lang('Please_select_Persons') ?> </option>
        ...
        <div class="col-md-2">
          <input type='button' style="width:185px!important;" class="search-submit-cal" value="<?php echo lang('SUBMIT'); ?>"  onclick="validate_search()"/>
        </div>
        </fieldset>
      </form>
    </div>
