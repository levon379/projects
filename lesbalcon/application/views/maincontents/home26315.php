    ...
    <div class="container">
      <div class="row">
        <form class="form-horizontal" id="mobile_search_form" action="search/mobile" method="POST">
          ...
          <div class="col-xs-12">
            <input id="mobile_search_keyword" name="mobile_search_keyword" placeholder="<?php echo lang('Keyword') ?>" class="form-control input-md" type="text">
			<label style="color:red;" id="mobile_search_keyword_error"></label>
          </div>
          <div class="col-xs-12">
            <label class="checkin"><?php echo lang('Check_In') ?></label>
            <div class='input-group date' id='datetimepicker5'>
					<input name="mobile_search_arrival_date" id="mobile_search_arrival_date" type='text' class="form-control" style="cursor:auto;" readonly data-date-format="DD/MM/YYYY"/>
          ...
          <div class="col-xs-12">
            ...
            <div class='input-group date' id='datetimepicker6'>
					<input name="mobile_search_leave_date" id="mobile_search_leave_date" type='text' class="form-control" style="cursor:auto;" readonly data-date-format="DD/MM/YYYY"/>
					<span class="input-group-addon">
						<span class="glyphicon glyphicon-calendar"></span>
					</span>
				</div>
