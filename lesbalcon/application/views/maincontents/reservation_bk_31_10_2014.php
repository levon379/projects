                    ...
                    <div class="form-row form-group">
					  <div class="col-md-4">
					   ...
					   <div class="input_fields_wrap col-md-6">
						   <input type="text" name="phone[]" class="login-input testi-input form-control input-md" value="<?php if(isset($reservation_session)){ echo $reservation_session['phone'][0]; } ?>">
