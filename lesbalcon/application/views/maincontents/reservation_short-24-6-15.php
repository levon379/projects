	                    ...
	                    <div class="form-row form-group">
							<div class="col-md-10">
								<div class="row">
									<div class="col-md-12">
										<div class="sub-btn">
											<input id="textinput" name="textinput" class="submit-button btn btn-default" type="button" value="<?php echo lang('Submit'); ?>" onclick="check_availability()" style="float:right">
										</div>
						...
						<div class="form-row form-group" id="div_folding_adult">
                      	...
                      	<div class="form-row form-group">
							<div class="col-md-10">
								<div class="row">
									<div class="col-md-6">
										<input id="textinput" name="textinput" class="submit-button btn btn-default" type="button" value="Back" style="float:left;" onclick="switch_forms_back();">
									</div>
									<div class="col-md-6">
										<div class="sub-btn">
											<input id="textinput" name="textinput" class="submit-button btn btn-default" type="submit" value="Continue" style="float:right">
										</div>
									</div>
								  </div>       
