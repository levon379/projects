...
function validate_desktop_search()
{
	...
	else if($("#search_keyword").val().trim()=="7"){
		$("#search_main_error").html("<?php echo lang('Max_search_keyword'); ?>");
...
{
	var error=0;
	$("#mobile_search_main_error_div").hide();
	...
	if(error>0){
		...
		if($("#mobile_search_arrival_date").val().trim()!=""){
			var arrival_date_val = $("#mobile_search_arrival_date").val();
			var valyear_val 	 = arival_date_arr[2];
			var valmonth_val 	 = arival_date_arr[1];
			var valday_val   	 = arival_date_arr[0]; 
			var arrival_date_val = new Date(valyear_val ,(valmonth_val -1),valday_val );
			...
			if(result_compare>0){
				$("#mobile_search_main_error_div").show();
				$("#mobile_search_main_error").html("<?php echo lang('search_message_72_hour_error'); ?>"); 
				return false;
			}else{
				
				date_arrival = $("#mobile_search_arrival_date").val();
				date_leave 	 = $("#mobile_search_leave_date").val();
				...
				$.ajax({
					...
					success: function(rs){
						if(rs=='1'){
							...
							$("#mobile_search_main_error_div").show();
							$("#mobile_search_main_error").html("<?php echo lang('Minimum_Two_Days'); ?>"); 
						}else if(rs=='3'){
							$("#mobile_search_main_error_div").show();
							$("#mobile_search_main_error").html("<?php echo lang('Minimum_Three_Days'); ?>"); 
						}
					}
				}); 
			}
...
<div class="row search-container">
      ...
      <div class="row">
        <form class="form-horizontal" id="mobile_search_form" action="search/mobile" method="POST">
          <fieldset> 
				...
				<div class="row"> 
					<div class="col-md-12" style="display:none; " id="mobile_search_main_error_div">
						<label style="color:red; padding:5px 10px; width:100%; border:2px solid #ff0000;" id="mobile_search_main_error"> </label>
					</div> 
				</div>
 ...
 <!-- Search For Mobile End--->
    ...
    <div data-ride="carousel" class="carousel slide" id="myCarousel">
      ...
      <div class="carousel-inner">
        ...
        <div class="container banner-search">
          <div class="search-box" style="padding: 35px 15px; min-height:500px;">
            <form class="form-horizontal" id="desktop_search_form" action="search" method="POST">
				<fieldset>
						...
						<div class="row">
							<!-- Form Name -->
							<div class="col-md-12">
								<legend><?php echo lang('Bungalowss') ?> <span><?php echo lang('Searchss') ?></span></legend>
							</div>
						</div>
						...
						<div class="row"> 
							<div class="col-md-12" style="display:none; " id="search_main_error_div">
								<label style="color:red; padding:5px 10px; width:100%; border:2px solid #ff0000;" id="search_main_error"></label>
							</div> 
						</div>
						...
						<div class="row">
							...
							<div class="col-md-12">
								<div class="form-group">
									...
									<div class="col-md-12">
										<input style="margin-top:10px;" id="singlebutton" name="singlebutton" class="btn btn-primary btn-custom" type="button" value="<?php echo lang('Submit') ?>" onclick="validate_desktop_search()">
									</div>
								</div>
							</div>
						</div>
  ...
  <div class="row content-area">
    <div class="container">
      <h2><img src="<?php echo base_url(); ?>assets/frontend/images/bracket-left.png" alt=""><?php echo lang('WELCOME_TO'); ?> <span><?php echo lang('LES_BAICONS'); ?></span><img src="<?php echo base_url(); ?>assets/frontend/images/bracket-right.png" alt=""></h2>
    ...
    <div class="container">
      <div class="bunglow-gallery">
		...
		if(count($bungalow)>0)
		{
			...
			<div class="booknow viewnow">
			  <p><a href="<?php echo base_url(); ?>bungalows"><?php echo lang('VIEW_NOW'); ?></a></p>
			</div>
			<div class="booknow">
