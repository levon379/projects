					...
					foreach($bungalows as $value){ ?>
						<div class="col-xs-6 col-sm-4 col-md-4">
							...
							<div class="content-box">
								...
								<div class="proprty_ttl"><?php
									/*  echo substr(strip_tags($value['bunglow_overview']),0, 70);  
									if(strlen(strip_tags($value['bunglow_overview']))>80){
										echo "...";
									} */ ?>
								</div>
									<div class="persons" style="word-wrap: break-word; width: 220px;text-align:center;"><?php
									...
									<div class="price" style="word-wrap: break-word; width: 100px;text-align:center;"><?php echo lang('FROM')." ".$value["extranight_perday_europrice"]." Euros/".lang('NIGHT'); ?></div>
								</div>
							</div>
						</div>
						<?php 
