...
*/
		...
		if($default_language_id==1)//If user language is english
		{
			...
			$msg_text2.='
				...
				<tr>
					<td style="border-top:1px solid #C9AD64; padding:5px; "><b>Comments  :</b></td><td style="border-top:1px solid #C9AD64; padding:5px; border-left:1px solid #C9AD64;">'.wordwrap($reservation_details[0]["invoice_comments"],100,"<br />\n",true).'</td>
				</tr>';
		...
		$msg_text2.='
			...
			<tr>
				<td style="border-top:1px solid #C9AD64; padding:5px;"><b>Commentaires:</b></td><td style="width:100%;border-top:1px solid #C9AD64; padding:5px; border-left:1px solid #C9AD64;">'.wordwrap($reservation_details[0]["invoice_comments"],100,"<br />\n",true).'</td>
			</tr>';
...
<br/>
	...
	function download_invoice($res_id){
		...
		$msg_text2 .= '<style> table{ max-width:1070px; margin-left:-50px;}</style>';
	...
	function send_invoice_multi($reservation_id)
	{
		...
		***/
		...
		if($default_language_id==1)//If user language is french
		{
			...
			$msg_text2.='
				<tr><td colspan="10">
				<span style="border:1px solid; padding:3px;"><b>Comments</b><br/>'.wordwrap($invoice_comments,100,"<br />\n",true).'</span>
				</td></tr>
				';
			...
			$msg_text2.='
				<tr><td colspan="10">
				<span style="border:1px solid; padding:3px;"><b>'.lang("User_Comments")."</b><br/>".wordwrap($invoice_comments,100,"<br />\n",true).'</span>
				</td></tr>
				';
