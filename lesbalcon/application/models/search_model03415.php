...
class search_model extends CI_Model
{
	...
	function desktop_search_process()
	{
		...
		{
			$this->db->from('lb_bunglow');
		$this->db->join('lb_bunglow_lang', 'lb_bunglow.id = lb_bunglow_lang.bunglow_id AND lb_bunglow.max_person LIKE "%'.$person_no.'%" AND lb_bunglow.is_active="Y" AND lb_bunglow_lang.language_id='.$current_lang_id);
			$search_arr = $this->db->get()->result_array();
