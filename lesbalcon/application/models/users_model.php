	...
	function get_invoice_details($reservation_id)
	{
		...
		if(count($invoice_details)==0) //If invoice is not available
		{
			...
			$comments     		=$payment_details[0]['comments'];
                        $invoice_comments     	=$payment_details[0]['invoice_comments'];
		...
		if(count($parent_info)>0) //If invoice is not available
		{
			...
			//	echo $parent_details['id'];
				...
				$invoice_arr[]=array(
					...
					'invoice_comments'		=>$parent_details['invoice_comments'],
...
*/
		...
		if($default_language_id==1)//If user language is english
		{
			...
			$msg_text2.='
				...
				<tr>
					<td style="border-top:1px solid #C9AD64; padding:5px;"><b>Paid Amount:</b></td><td style="border-top:1px solid #C9AD64; padding:5px; border-left:1px solid #C9AD64;">'.$default_currency.' '.$paidAmt.'</td>
				</tr>								
				<tr bgcolor="#f5e8c8">
				...
				<tr>
					<td style="border-top:1px solid #C9AD64;padding:5px;font-size:10px"><b>Comments  :</b></td><td style="border-top:1px solid #C9AD64; padding:5px; border-left:1px solid #C9AD64;">'.wordwrap($reservation_details[0]["invoice_comments"],65,"<br />\n",true).'</td>
				</tr>'; 
			...
			//if($reservation_details[0]["amount_to_be_paid"] == $reservation_details[0]["paid_amount"])
                        // Condition Changed by Waxim
                            if($reservation_details[0]["paid_amount"]>0)
                            {
				$msg_text2.='
				<tr>
					<td style="border-top:1px solid #C9AD64; padding:5px;font-size:10px;" colspan="2"><b>
						CANCELLATION POLICY  :-<br/><br/>
                                                - For a stay from may 1st to October 31st : if you cancel during the 30 days prior to the arrival the deposit is non-refundable and the balance is due and will be billed to your credit card.<br>
                                                - For a stay from November 1st to April 30th : if you cancel during the 60 days prior to the arrival the deposit is non-refundable and the balance is due and will be billed to your credit card.<br>
                                                All refunds will be subject to a 15 % service fee.<br/><br/>
                                                *Rules:-<br/><br/>
						- On the day of your departure, unless otherwise agreed, you are kindly requested to leave your bungalow before 11 :00 AM.<br>
                                                - Please dispose of your waste in the designated waste container outside on the top parking lot or the recycle containers at each entrance of Oyster Pond<br> 
                                                - Please do NOT smoke inside of the unit.<br>
                                                - Please wash your dishes ,your fridge & BBQ  before your departure<br>
                                                - Please switch off air-conditioning and lights before your departure<br>
                                                - The remote control of the alarm system is not waterproof , please be careful with it<br>
                                                - If we are out of the office at your departure, please drop your keys on our "drop off" keys box in our door office.<br>
                                                - During your stay , please be quiet in the residence and at the pool area to not disturb the others guests.<br>
                                                If these rules are not respected , you authorize us to charge your credit card the amount of 100 Euros.<br>
                                                <br/><br/>
                                                CHECK IN & CHECK OUT :-<br/><br/>
                                                - Our check-in time is from 3:30 PM to 6:30 PM. For delayed, night arrival or Sunday arrival (when the office is closed)   : <br/>  Please note that we will give you a key lock box code to access to your  bungalow  keys.<br>
                                                - On the day of your departure, unless otherwise agreed, you are kindly requested to leave your bungalow before 11 :00 AM.<br>
					</b></td>
				</tr>';
			}
		...
		$msg_text2.='
			...
			$msg_text2 .='
			<tr bgcolor="#f5e8c8">
				<td style="border-top:1px solid #C9AD64; padding:5px;"><b>Total de la taxe de séjour : </b></td><td style="border-top:1px solid #C9AD64; padding:5px; border-left:1px solid #C9AD64;">'.$default_currency.' '.number_format($tax , 2, '.', ',').'</td>
			</tr>
			<tr>
			...
			<tr>
				<td style="border-top:1px solid #C9AD64; padding:5px;"><b>Acompte payé :</b></td><td style="border-top:1px solid #C9AD64; padding:5px; border-left:1px solid #C9AD64;">'.$default_currency.' '.$paidAmt.'</td>
			</tr>								
			<tr bgcolor="#f5e8c8">
			...
			<tr>
				<td style="border-top:1px solid #C9AD64; padding:5px;"><b>Commentaires:</b></td><td style="width:100%;border-top:1px solid #C9AD64; padding:5px; border-left:1px solid #C9AD64;">'.wordwrap($reservation_details[0]["invoice_comments"],65,"<br />\n",true).'</td>
			</tr>';
		...
		if($reservation_details[0]["amount_to_be_paid"] == $reservation_details[0]["due_amount"]){
			...
			<tr>
				<td style="border-top:1px solid #C9AD64; padding:5px;" colspan="2"><b>
					* Votre réservation ne sera confirmée qu’une fois que le paiement de l’acompte ou la totalité du séjour sera effectué.
				</b></td>
			</tr>';
		}
		//if($reservation_details[0]["amount_to_be_paid"] == $reservation_details[0]["paid_amount"])
                // Condition added by Waxim
                if($reservation_details[0]["paid_amount"]>0)
                    {
			$msg_text2.="
			<tr>
				<td style=' word-wrap: break-word;border-top:1px solid #C9AD64; padding:5px;' colspan='2'><b>
					CONDITIONS D’ANNULATION :-<br><br>
                                    -Pour un séjour situé entre le 1er novembre et le 30 avril : si l’annulation a lieu dans les 60 jours qui précèdent votre date d’arrivée, l’acompte est conservé et le solde est dû et sera débité sur votre carte bancaire. <br>
                                    -Pour un séjour situé entre le 1er mai et le 31 octobre : si l’annulation a lieu dans les 30 jours qui précèdent votre date d’arrivée, l’acompte est conservé et le solde est dû et sera débité sur votre carte bancaire.<br>
                                    Tous remboursement est sujet à 15% de frais de dossier.
                                    <br><br>
                                    REGLEMENT :-<br><br>
                                    - Le jour de votre départ, vous êtes priés de quitter le bungalow avant 11h00 (sauf disposition préalable)<br>
                                    - Prière de jeter les poubelles au cours de votre séjour et avant votre départ dans le container prévu à cet effet, situé dans la rue.<br>
                                    - Prière de ne pas fumer à l’intérieur du bungalow, merci.<br>
                                    - Prière de nettoyer la vaisselle, le frigo et le BBQ  le jour de votre départ.<br>
                                    - Prière d’éteindre la climatisation et les lumières avant votre départ<br>
                                    - La télécommande du système d’alarme n’est pas étanche. Merci d’en prendre soin<br>
                                    - Durant votre séjour merci de  ne pas faire du bruit qui pourrait déranger les autres clients ni à la piscine, ni dans la résidence.<br>
                                    - Si nous sommes absents du bureau, lors de votre départ, nous vous prions de laisser les clefs dans la boite « retour clefs » à la réception<br>
                                    Si l’un de ces articles n’est pas respecté, vous nous autorisez à déduire 100 euros de la carte bancaire dont vous vous êtes servis pour le paiement de l’acompte (mentionnée ci –dessus)
                                    <br><br>

                                    ARRIVEES & DEPARTS :-<br><br>
                                    - Nos heures d’arrivées sont de 15h30 à 18h30 . Pour les arrivées après ces heures ou le dimanche (quand notre bureau est fermé ) , nous vous donnons un code pour accéder à vos clefs de bungalow.<br>
                                    - Le jour de votre départ, vous êtes priés de quitter le bungalow avant 11h00 (sauf disposition préalable)<br>
				</b></td>
			</tr>";
		}
		...
		//echo "<div style='width:990px;margin:auto'>".$msg_text2."</div>"; die;
		return "<page style='width:100%'>".$msg_text2."</page>";
	}	
	...
	function download_invoice($res_id){
		...
		if(count($parent_info)>0) //If invoice is not available
		{
			$msg_text2 =  $this->send_invoice_multi($res_id);
                        $msg_text2 .= '<style>table{ max-width:1050px; margin-left:-50px;}</style>';
			...
			if(count($results_array1) > 0){
				...
				$msg_text2 .= '<style>table{ max-width:1000px;}</style>';
			}
	...
	function send_invoice_multi($reservation_id)
	{
		...
		***/
		...
		if($default_language_id==1)//If user language is french
		{
			...
			if(count($parent_info)>0) //If invoice is not available
			{
				foreach ($parent_info as $parent_details) 
				{
					...
					$amount_with_tax = $amount_without_tax + $tax;
			...
			if($totalDiscount>0)
			{
				$totalDiscountStr = '<b>Total Amount with Discount: </b>% '.$amount_with_tax.'<br/>';
			}
			$msg_text2.='<tr>
					<td colspan="10">&nbsp;</td>
				</tr>
				<tr>
					<td colspan="10" align="center">
						...
						<b>Total Amount: </b>'.$default_currency.' '.number_format($amount_to_be_paid, 2, '.', ',').'<br/>
						'.$totalDiscountStr.'
			...
			$msg_text2.='
				<tr><td colspan="10">
				<span style="border:1px solid; padding:3px;"><b>Comments</b><br/>'.wordwrap($invoice_comments,75,"<br />\n",true).'</span>
				</td></tr>
				';
			...
			//if($amount_to_be_paid == $paid_amount)
				...
				$msg_text2.='
				<tr>
					<td style="border-top:1px solid #C9AD64; padding:5px;font-size:10px;" colspan="10"><b>
						CANCELLATION POLICY  :-<br/><br/>
                                                - For a stay from may 1st to October 31st : if you cancel during the 30 days prior to the arrival the deposit is non-refundable  and the balance is due and will be billed to your credit card.<br>
                                                - For a stay from November 1st to April 30th : if you cancel during the 60 days prior to the arrival the deposit is non-refundable  and the balance is due and will be billed to your credit card.<br>
                                                All refunds will be subject to a 15 % service fee.<br/><br/>
						...
						- On the day of your departure, unless otherwise agreed, you are kindly requested to leave your bungalow before 11 :00 AM.<br>
                                                ...
                                                <br/><br/>
                                                CHECK IN & CHECK OUT :-<br/><br/>
                                                - Our check-in time is from 3:30 PM to 6:30 PM. For delayed, night arrival or Sunday arrival (when the office is closed)   :  Please note that we will give you a key lock box code to access to your  bungalow  keys.<br>
                                                - On the day of your departure, unless otherwise agreed, you are kindly requested to leave your bungalow before 11 :00 AM.<br>
					</b></td>
				</tr>';
			}
			...
			if($totalDiscount>0)
			{
				$totalDiscountStr = '<b>Total Amount with Discount: </b> '.number_format($amount_to_be_paid, 2, '.', ',').'<br/>';
			}
			$msg_text2.='<tr>
					<td colspan="10">&nbsp;</td>
				</tr>
				<tr>
					<td colspan="10" align="center">
						...
						<b>Total du séjour: </b>'.$default_currency.' '.number_format($amount_with_tax, 2, '.', ',').'<br/>
						'.$totalDiscountStr.'
						<b>Acompte payé : </b>'.$default_currency.' '.$paid_amount.'<br/>
						<b>Montant dû: </b>'.$default_currency.' '.number_format($due_amount, 2, '.', ',').'<br/>
					</td>
				</tr>
				';
			if($amount_to_be_paid == $due_amount){
			...
			$msg_text2.='
				<tr><td colspan="10">
				<span style="border:1px solid; padding:3px;"><b>'.lang("User_Comments")."</b><br/>".wordwrap($invoice_comments,75,"<br />\n",true).'</span>
				</td></tr>
				';
		...
		//echo $msg_text2; die;
		return '<div style="width:850px; margin:0 auto;">'.$msg_text2.'</div>'; 
	}	
