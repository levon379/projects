...
class reservation_model extends CI_Model
{
	...
	function ajax_check_availability($bungalow_id, $arrival_date, $leave_date)
	{
		...
		//{
			...
			{
				$check_query=$this->db->query("SELECT * FROM `lb_reservation` WHERE `bunglow_id`='$bungalow_id' AND (`arrival_date` <= '$date' AND `leave_date` >= '$date') AND `is_active`!='DEACTIVE'")->result_array();
	...
	function send_email_process()
	{
		...
		$msg_text1.='
			...
			<tr bgcolor="#f5e8c8">
				<td style="border-top:1px solid #C9AD64; padding:5px;"><b>'.lang('Name').': </b></td><td style="border-top:1px solid #C9AD64; padding:5px; border-left:1px solid #C9AD64;">'.$reservation_session['name'].'</td>
			</tr>
			<tr>
			...
			<tr>
				<td style="border-top:1px solid #C9AD64; padding:5px;"><b>'.lang('Bungalow').':</b></td><td style="border-top:1px solid #C9AD64; padding:5px; border-left:1px solid #C9AD64;">'.$bungalow_details[0]['bunglow_name'].'</td>
			</tr>
			<tr bgcolor="#f5e8c8">
				<td style="border-top:1px solid #C9AD64; padding:5px;"><b>'.lang('Bungalow').' '.lang('Rate').':</b></td><td style="border-top:1px solid #C9AD64; padding:5px; border-left:1px solid #C9AD64;">'.$currency_arr[0]['currency_symbol'].$payment_session['total_bungalow_rate'].'</td>
			</tr>
			<tr>
				<td style="border-top:1px solid #C9AD64; padding:5px;"><b>Options '.lang('Rate').':</b></td><td style="border-top:1px solid #C9AD64; padding:5px; border-left:1px solid #C9AD64;">'.$options_text.'</td>
			</tr>
			<tr bgcolor="#f5e8c8">
				<td style="border-top:1px solid #C9AD64; padding:5px;"><b>'.lang('Discount').':</b></td><td style="border-top:1px solid #C9AD64; padding:5px; border-left:1px solid #C9AD64;">'.$payment_session['discount'].'%</td>
			</tr>
			<tr>
				<td style="border-top:1px solid #C9AD64; padding:5px;"><b>'.lang('Tax').' '.lang('Rate').':</b></td><td style="border-top:1px solid #C9AD64; padding:5px; border-left:1px solid #C9AD64;">'.$taxes_text.'</td>
			</tr>
			<tr>
				<td style="border-top:1px solid #C9AD64; padding:5px;"><b>'.lang('Payment_Mode').':</b></td><td style="border-top:1px solid #C9AD64; padding:5px; border-left:1px solid #C9AD64;">'.$payment_type.'</td>
			</tr>
			<tr bgcolor="#f5e8c8">
				<td style="border-top:1px solid #C9AD64; padding:5px;"><b>Total:</b></td><td style="border-top:1px solid #C9AD64; padding:5px; border-left:1px solid #C9AD64;">'.$currency_arr[0]['currency_symbol'].$payment_session['total_charge'].'</td>
			</tr>';
