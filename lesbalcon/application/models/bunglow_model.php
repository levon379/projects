	...
	function get_bungalows($limit, $offset){
		...
		foreach($array as $value){
			...
			if($seasons_rate_arr){
				...
				$bungalows_arr[$i]['rate_per_day_euro']				= $seasons_rate_arr[0]['rate_per_day_euro'];
				$bungalows_arr[$i]['extranight_perday_europrice'] 	= $seasons_rate_arr[0]['extranight_perday_europrice'];
			}else{
				$bungalows_arr[$i]['rate_per_week_euro']			= "N/A";
				$bungalows_arr[$i]['rate_per_day_euro']				= "N/A";
				$bungalows_arr[$i]['extranight_perday_europrice'] 	= "N/A";
			}
			//echo "<pre>"; print_r($seasons_rate_arr); die;
