...
class search_model extends CI_Model{
	...
	function desktop_search_process(){
		...
		if($person_no=="" && $posted_arrival_date!="" && $posted_leave_date!=""){
			...
			$season_date_start	= $arrival_date_arr[2] ."-12-15";
			$season_date_end	= $arrival_date_arr[2]+1 ."-04-14";
			...
			$season_date_start		= strtotime("2015-12-15");
			$season_date_end		= strtotime("2016-04-14");
			...
			$where = '';
			if($total_days < 5){
				$where = ' AND lb_bunglow.slug NOT IN ("bungalow-with-terrace-marina-level-1", "bungalow23-suite-with-2-separated-bedrooms-terrace-jacuzzi", "bungalow21-suite-with-separated-bedroom-and-xtra-large-terrace", "sweety-cottage")';
			} 
			...
			foreach($search_arr as $search){
				...
				if(count($available_date)==$total_days+1){
