...
<A NAME="past-postings"></A>
<h2>@lang('site_content.create_edit_a_post_Past_Posts_Header')</h2>
...
<table class="table buy">
  <thead>
    <tr>
      ...
      <th>@lang('site_content.create_edit_a_post_Product_Column_Header_Post_Date')</th>
      <th>@lang('site_content.create_edit_a_post_Product_Column_Header_Repost_Product')</th>
    </tr>
  </thead>
  
  <tbody>
    @foreach($buyPastProduct as $bpKey => $bpVal)
		<tr>
        ...
        <!-- Original Post Date -->
        <td>
          {{{ Util::makeDate('Y-m-d', $bpVal->created_at) }}}
        </td>
...
<table class="table sell">
  ...
  <tbody>
    @foreach($sellPastProduct as $spKey => $spVal)
        <tr>
        ...
        <!-- Original Post Date -->
        <td>
          {{{ Util::makeDate('Y-m-d', $spVal->created_at) }}}
        </td>
