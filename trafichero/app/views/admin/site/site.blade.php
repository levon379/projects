                                ...
                                <tbody>
                                    ...
                                    <tr id="row_{{{$site->idsite}}}">
                                        ...
                                        <td>
                                            ...
                                            <div class="modal fade" id="myModal{{$site->idsite}}" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                                                <div class="modal-dialog">
                                                    <div class="modal-content" style="margin-top: 65px;">
                                                        ...
                                                        {{ Form::open(array('action' => array('SitesController@updateSiteById', $site->idsite), 'method' => 'post', 'class'=>'form-signin')) }}
                                            ...
                                            <a href="<?php echo route('admin_delete_site', ['id' => $site->idsite]); ?>" onclick="return confirm('Are You sure You want to delete this site from site list?')" class="btn btn-sm btn-danger" ><i class="fa fa-trash"></i></a>
                                        </td>
                                    </tr>
                                    @endforeach
                                </tbody>
