                                                ...
                                                <table id="stream_table" class="table table-striped">
                                                    ...
                                                    <tbody>
														...
														<tr id="row_{{{$user->id}}}">
															...
															<td>{{date("Y m d H:s:i",strtotime($user->created_at))}}</td>
															<td><a href="javascript:;" onclick="fill_userId('{{{$user->id}}}');" class="btn btn-sm btn-info " data-toggle='modal' data-target ='#myModal'><i class="fa fa-edit"></i></a>
															<a href="javascript:;" onclick="delete_user({{{$user->id}}});" class="btn btn-sm btn-danger" ><i class="fa fa-trash"></i></a></td>
														</tr>
														@endforeach
                                                    </tbody>
