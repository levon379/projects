...
<div class="login-sec">
    <div class="login">
        <div class="login-form">
           ...
           {{ Form::open(array('route' => 'do_admin_login', 'method' => 'post', 'id' => 'form', 'data-toggle' => 'validator', 'role' => 'form')) }}
                <fieldset>{{ Form::email('email', null, array('placeholder'=>'Email Address adm', 'required' => '', 'autofocus' => '')) }}<i class="fa fa-user"></i></fieldset>
