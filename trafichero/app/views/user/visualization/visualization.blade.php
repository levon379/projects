        ...
        <div class="row">
            ...
            <div class="col-xs-2">
                ...
                <select class="form-control" name="group" id="group">
                    ...
                    <option value="just_url">Page URL</option>
        ...
        $(this).popover({
            ...
            content: function () {
                return "ip: " + d.cip + "<br />" +
                        ...
                        "OS: " + d.browser.platform + "<br />" +
                        "Browser: " + d.browser.name + "<br />" +
                        "Page: " + d.url + "<br />" +
                        "Page Title: " + d.action_name;
            }
        });
        $(this).popover('show')
    }
    ...
    function new_data() {
        ...
        $.ajax({
            ...
            'success': function (data1) {
                ...
                for (var i = 0; i < data.length; i++) {
                    ...
                    for (var j = 0; j < data1.length; j++) {
                        if (data1[j].cip == ip) {
                            ...
                            data[i]['activity'] = data1[j]['activity'];
                            //data[i] = data[1][j];
                ...
                old_data_cirlcles = setInterval(function () {
                    draw(group_term);
                }, 1000);
