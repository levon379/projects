...
<body style="background-image: url('<?php echo URL::to('/'); ?>/images/resource/login-bg.jpg')">

<div class="login-sec">
    <div class="login">
        <div class="login-form">
            <span><img src="<?php echo URL::to('/'); ?>/images/logo.png" alt="" /></span>
            <h5><strong>Identify</strong> Yourself</h5>
           {{ Form::open(array('route' => 'do_login', 'method' => 'post', 'id' => 'form', 'data-toggle' => 'validator', 'role' => 'form')) }}
                <fieldset>{{ Form::email('email', null, array('placeholder'=>'Email Address', 'required' => '', 'autofocus' => '')) }}<i class="fa fa-user"></i></fieldset>
