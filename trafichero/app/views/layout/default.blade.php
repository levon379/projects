                ...
                <div class="dropdown profile">
                    ...
                    <div class="profile drop-list">
                        <ul>
                            ...
                            <li><a href="/logout" title=""><i class="fa fa-power-off"></i>Log Out</a></li>
                        </ul>
                ...
                <aside class="sidebar">
                    <div class="profile-stats">
                        <div class="mini-profile">
                            ...
                            <a href="/admin/logout" title="Logout" class="logout red" data-toggle="tooltip" data-placement=
                        ...
                        <div id="menu-toogle" class="menus">
                            <div class="single-menu">
                                <h2 class="<?php if (isset($home) && $home): ?> active <?php else: ?>  <?php endif ?>">
                                    <a href="<?php echo route('admin_dashboard'); ?>" title="">
...
<!--                                <div class="sub-menu">
                                    <ul>
                                        <li>{{HTML::link(URL::route('visitor'), 'Visitor List') }}</li>
                                        <li> {{HTML::link(URL::route('admin_visualization'), 'Visualization') }}</li>
                                        <li>{{HTML::link(URL::route('history'), 'History') }}</li>
                                        <li><a title="">Landing Page</a><span class="badge red">Soon</span></li>
                                    </ul>
                                </div>-->
                            </div>
                            <div class="single-menu">
                                <h2 class="<?php if (isset($user_section) && $user_section): ?> active <?php else: ?> <?php endif ?>">
                                    <a href="<?php echo route('user_index'); ?>">
...
<!--                                <div class="sub-menu">
                                    <ul>
                                        <li>{{HTML::link(URL::route('user_index'), 'User List') }}</li>
                                        <li>{{HTML::link(URL::route('user_site'), 'Site List') }}</li>
                            ...
                            <div class="single-menu">
                                <h2 class="<?php if (isset($site_section) && $site_section): ?> active <?php else: ?> <?php endif ?>">
                                    <a href="<?php echo route('user_site'); ?>">
