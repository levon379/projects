...
Route::get('/', 'LoginController@showLogin');
Route::any('weekly-data', 'SitesController@setWeeklyData');
Route::any('test-data', 'SitesController@testWeeklyData');
Route::post('/doLogin', array('as' => 'do_login', 'uses' => 'LoginController@doLogin'));
Route::group(array('domain' => 'traffichero.kvdev.kvsocial.com'), function() {
...
if (file_exists(__DIR__ . '/routes.local.php')) {
    require_once __DIR__ . '/routes.local.php';
}
