...
class ImagesController extends Controller {
    ...
    public function viewProductImage($image_hash,$type)
    {
        ...
        //$path = str_replace('Houston-Integration', 'houston', $path);
        $path = str_replace("ecoartttest".DIRECTORY_SEPARATOR."prelive", 'ecoarttestadmin'.DIRECTORY_SEPARATOR.'houston', $path);
        $path = str_replace("ecoartlive".DIRECTORY_SEPARATOR."ecoart", 'houstonecoart'.DIRECTORY_SEPARATOR.'houston', $path);
