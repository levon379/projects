            ...
            <table class="table">
                <tbody><tr>
                    ...
                    <tr>
                        ...
                        <td><a href="/Product/update/<?php echo $order['id']?>" ><?php echo $order['name']?></a></td>
                        <td><?php if($order['type'] == 1):?>Twitter design<?php else: ?>Facebook design<?php endif;?></td>
                        <td><?php echo sprintf('€ %.2f',$order['price'])?></td>
                        <td><a href="/Product/delete/<?php echo $order['id']?>"><span class="glyphicon glyphicon-remove" aria-hidden="true"></span></a></td>
                    </tr>
                    <?php endforeach;?>
                </tbody></table>
