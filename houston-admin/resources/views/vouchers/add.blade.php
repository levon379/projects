...
@section("content")
	<div class="page-header"><h1>Vouchers <small>Add</small></h1></div>
	...
	<div class="row">
		<div class="btn-group btn-breadcrumb col-lg-12">
			...
			<a class="btn btn-default active" href="{{ URL::to("/admin/vouchers/add") }}" style="z-index: 2;"><div>Add Voucher</div></a>
		</div>
		<div class="col-lg-12">
			<br>
			<div class="panel panel-default">
				...
				<div class="panel-body">
					<form action="{{ URL::to("/admin/vouchers/add") }}" method="post">
