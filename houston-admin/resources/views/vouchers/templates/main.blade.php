                    ...
                    <div class="meeting-details">
                        ...
                        <div class="bottom-hold">
                            <div class="map-holder">
                                <a href="https://www.google.com/maps?ll=41.888198,12.49638&z=16&t=m&hl=it-IT&gl=IT&mapclient=embed&cid=8917026822022700582" target="_blank"><img src="[[map_image]]" alt="image description"></a>
                            </div>
                            <div class="payment-info">
                                <span class="paid">[[product_name]]: <span class="amount">[[tour_paid]]</span> (<span class="through">[[payment_method]]</span>)</span>
                                @foreach ($booking->addons as $bookingAddon)
                                    <span class="paid">{{ $bookingAddon->addon->name }} <span class="amount">{{ $bookingAddon->paid }} EUR ({{ $bookingAddon->paymentMethod->name }})</span></span>
                                @endforeach
                                <span class="paid">Total Paid: <span class="amount">[[total_paid]]</span></span>
                            </div>
                        </div>
                    </div>
                </div>
