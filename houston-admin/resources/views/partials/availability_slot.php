<script id="availability-slot-template" type="text/x-handlebars-template">
    {{#availability_slot}}
    <div class="panel panel-default panel-success availability-panel" data-id="{{id}}" data-date="{{../date}}" id="availability-panel-{{../date}}-{{id}}">
...
<script id="guides-template" type="text/x-handlebars-template">
    {{#guides}}
    <div class="result-element">
        {{#if active}}
            <span class="confirm text-success">
        ...
        {{/if}}
        <span {{#if unmatch}}class="unmatch"{{/if}}>{{name}}</span>
    </div>
    {{/guides}}
</script>

<script id="guides-load-template" type="text/x-handlebars-template">
    {{#guides}}
    <li {{#if selected}}class="selected"{{/if}}>
        ...
        {{/if}}
        <input type="checkbox" value="{{id}}" id="{{base_id}}-{{id}}" {{#if selected}}checked{{/if}} data-unmatch="{{unmatch}}">
        <label for="{{base_id}}-{{id}}" {{#if unmatch}}class="unmatch"{{/if}}>{{name}}</label>
    </li>
    {{/guides}}
</script>
