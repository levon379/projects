...
$section = explode("/assets/", $_SERVER["SCRIPT_FILENAME"]);
$url= $section[0]; //тут нужен полный путь (не url!)
$IMGFOLDER = $url.'/assets/img/vacancy_photo';
$IMGURL = $url_site.'/assets/img/vacancy_photo';
$VIDEOICON = 'video.jpg';
$AUDIOICON = 'audio.jpg';
// language setting   en
$LARGEIMG = 'Большая картинка';
$DELETEIMG = 'Удалить картинку';
$INSERTIMG = 'Вставить картинку в HTML';
$UPLOADIMG = 'Загрузить';
$HELPSTR = 'Выберите картинку!';
// -------------------------------------------------
?>
  ...
  if (count($file_lista) > 0) {
      for ( $a=0; $a<sizeof($file_lista); $a++) {
          ...
          if (((substr($fnev,-4)==".jpg") || (substr($fnev,-4)==".gif") ||
                ...
                $belyegurl = $site.'/assets/uploads/images/'.rawurlencode($picname).'_t'.substr($file_lista[$a],-4);
