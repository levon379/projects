...
//        //return TRUE;
//        $_CI->db = $_CI->load->database('default', TRUE, TRUE);
//        $_CI->db->select();
//        $_CI->db->from('admins');
//        $_CI->db->where('username', $_CI->session->get_userdata('username'));
...
//        }
    ...
    public function upload($lang = 'english') {
        ...
        if ($this->upload->do_upload()) {
            ...
            $result['result'] = $config['upload_path']; //$this->upload->display_errors(' ', '<br />');
