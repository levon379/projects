...
{section name=i max=5 loop=$topleaders}
    ...
    <div class="llt_top_right">
        ...
        <div class="llt_asset">{$topleaders[i].b_asset}</div>
        ...
        <div class="llt_bottom_left">
            <div class="like" id="like_{$topleaders[i]['b_asset_id']}">
				...
				{if $topleaders[i][1].you_like}<a href="javascript:void(0)"  onclick="like({$topleaders[i]['b_asset_id']},{$like_user_id},{$topleaders[i]['user_id']});">{/if}
				<div class="like_text"><span id="like_count_{$topleaders[i]['b_asset_id']}">{$topleaders[i][0].like_count}</span> likes this trade</div>
				{if $topleaders[i][1].you_like}</a>{/if}
				</div>
    ...
    <div class="llt_bottom_right">
       ...
       <!-- <div class="llt_c_price"><span>Current Price</span></br>{$topleaders[i].current_price}</div>
        ...
        <div class="ratio" style="padding-left:0;width: 94px;"><span>Payout</span></br>{$topleaders[i].w_rates}%</div>
