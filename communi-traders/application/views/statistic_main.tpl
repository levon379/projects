        ...
        <div id="tool_menu_static">
            <div id="navigation">
                ...
                <div class="menu_tab menu_tab_border">
                    <div class="menu_a">
                        <div class="a_text">
                            <a href="{$url}myperformance/{$user_name}">My Performance</a>
                        </div>
                    </div>
                </div>
                <div class="menu_tab menu_tab_border">
                ...
                <table class="table table-bordered td_name">
                    <thead>
                        <tr class="table_header">
                            ...
                            <th><a href="{$forum_url}members/{$user_id}-{$user_name}" class = "profile_link">Edit</a></th>
                        </tr>
                    ...
                    <tbody class="reports_block">
                        ...
                        <tr>
                            <td class="td_name table_header_second">{$user_name} Trading Experience</td>
                            <td class="td_name table_header_second">{$aboutRows.expirience}</td>
                        </tr>
                        <tr>
                            <td class="td_name">Win Trades Ratio</td>
                            <td>{$aboutRows.winTradesRate}</td>
                        </tr>
                        <tr>
                            <td>P&L</td>
                            <td>{$aboutRows.pl}</td>
        ...
        <div id="reports_right_part">
            ...
            <div id="performance_table">
                <table class="table table-bordered td_name">
                    <thead>
                        <tr class="table_header">
                            <th colspan="6">{$user_name} Performance Report:</th>
                        </tr>
                        ...
                        <tbody class="reports_block">
                            {section name=ft loop=$finishedTrades}
                                <tr class="history_trade">
                                    ...
                                    <td>${$finishedTrades[ft].f_price}</td>
                                    {if $finishedTrades[ft].game_result==1}
