...
class Authorize_net_arb
{
    ...
    public function Authorize_net_arb()
    {
        $this->CI = & get_instance();
        
        $this->test = (bool) $this->CI->config->item('authorize_net_arb_test_mode');
        if ($this->test)
        {
             $this->login = $this->CI->config->item('authorize_net_arb_test_login');
             $this->transkey = $this->CI->config->item('authorize_net_arb_test_tran_key');
             $this->url = $this->CI->config->item('authorize_net_arb_test_api_host');
        } else
        {
             $this->login = $this->CI->config->item('authorize_net_arb_live_login');
             $this->transkey = $this->CI->config->item('authorize_net_arb_live_tran_key');
             $this->url = $this->CI->config->item('authorize_net_arb_live_api_host');
        }
