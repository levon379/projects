...
use frontend\models\TodosSearch;
...
class TodosController extends Controller
{
    ...
    public function actionCreate()
    {
        ...
        $todoListId = $request['Todos']['todolist_id'];
        $list = \frontend\models\Todolists::findOne($todoListId);

        if ($model->load(Yii::$app->request->post()) && $model->save()) {
            return $this->redirect('/swots/details/'.$list->swot_id);
        } else {
    ...
    public function actionUpdate($id)
    {
        ...
        */
        if ($model->load(Yii::$app->request->post()) && $model->save()) {
            $id = $request['swot_id'];
            return $this->redirect('/swots/details/'.$id);
        } else {
